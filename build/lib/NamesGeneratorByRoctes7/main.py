...
def FixCorners(arr):
    for i in range(len(arr)):
        for j in range(len(arr[i])):
            ...
            try:
                if i > 0 and j > 0:
                    if arr[i][j] == Constants.EmptySpace and arr[i + 1][j] != Constants.EmptySpace and arr[i][j - 1] != Constants.EmptySpace and \
                    ...
                    elif arr[i][j] == Constants.EmptySpace and arr[i + 1][j] !=Constants.EmptySpace and arr[i + 1][j - 1] != Constants.EmptySpace and \
